...
Future<BindingLiquidSdk> connect({required ConnectRequest req}) =>
    BreezLiquid.instance.api.crateBindingsConnect(req: req);

/// If used, this must be called before `connect`. It can only be called once.
Stream<LogEntry> breezLogStream() => BreezLiquid.instance.api.crateBindingsBreezLogStream();

Config defaultConfig({required LiquidNetwork network, String? breezApiKey}) =>
    BreezLiquid.instance.api.crateBindingsDefaultConfig(network: network, breezApiKey: breezApiKey);

LNInvoice parseInvoice({required String input}) =>
    BreezLiquid.instance.api.crateBindingsParseInvoice(input: input);
...
class BindingEventListener {
  ...
  Future<void> onEvent({required SdkEvent e}) =>
      BreezLiquid.instance.api.crateBindingsBindingEventListenerOnEvent(that: this, e: e);
