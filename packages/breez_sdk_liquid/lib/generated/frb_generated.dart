...
class BreezLiquid extends BaseEntrypoint<BreezLiquidApi, BreezLiquidApiImpl, BreezLiquidWire> {
  @internal
  static final instance = BreezLiquid._();
  ...
  static void initMock({required BreezLiquidApi api}) {
  ...
  @override
  ApiImplConstructor<BreezLiquidApiImpl, BreezLiquidWire> get apiImplConstructor => BreezLiquidApiImpl.new;

  @override
  WireConstructor<BreezLiquidWire> get wireConstructor => BreezLiquidWire.fromExternalLibrary;
...
abstract class BreezLiquidApi extends BaseApi {
...
class BreezLiquidApiImpl extends BreezLiquidApiImplPlatform implements BreezLiquidApi {
  BreezLiquidApiImpl({
...
class BindingLiquidSdkImpl extends RustOpaque implements BindingLiquidSdk {
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: BreezLiquid.instance.api.rust_arc_increment_strong_count_BindingLiquidSdk,
    rustArcDecrementStrongCount: BreezLiquid.instance.api.rust_arc_decrement_strong_count_BindingLiquidSdk,
    rustArcDecrementStrongCountPtr:
        BreezLiquid.instance.api.rust_arc_decrement_strong_count_BindingLiquidSdkPtr,
  );

  Future<void> acceptPaymentProposedFees({required AcceptPaymentProposedFeesRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkAcceptPaymentProposedFees(that: this, req: req);

  Stream<SdkEvent> addEventListener() =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkAddEventListener(that: this);

  void backup({required BackupRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkBackup(that: this, req: req);

  Future<String> buyBitcoin({required BuyBitcoinRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkBuyBitcoin(that: this, req: req);

  CheckMessageResponse checkMessage({required CheckMessageRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkCheckMessage(that: this, req: req);

  Future<CreateBolt12InvoiceResponse> createBolt12Invoice({required CreateBolt12InvoiceRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkCreateBolt12Invoice(that: this, req: req);

  Future<void> disconnect() => BreezLiquid.instance.api.crateBindingsBindingLiquidSdkDisconnect(that: this);

  void emptyWalletCache() =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkEmptyWalletCache(that: this);

  Future<List<Rate>> fetchFiatRates() =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkFetchFiatRates(that: this);

  Future<LightningPaymentLimitsResponse> fetchLightningLimits() =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkFetchLightningLimits(that: this);

  Future<OnchainPaymentLimitsResponse> fetchOnchainLimits() =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkFetchOnchainLimits(that: this);

  Future<FetchPaymentProposedFeesResponse> fetchPaymentProposedFees({
    required FetchPaymentProposedFeesRequest req,
  }) => BreezLiquid.instance.api.crateBindingsBindingLiquidSdkFetchPaymentProposedFees(that: this, req: req);

  Future<GetInfoResponse> getInfo() =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkGetInfo(that: this);

  Future<Payment?> getPayment({required GetPaymentRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkGetPayment(that: this, req: req);

  Future<List<FiatCurrency>> listFiatCurrencies() =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkListFiatCurrencies(that: this);

  Future<List<Payment>> listPayments({required ListPaymentsRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkListPayments(that: this, req: req);

  Future<List<RefundableSwap>> listRefundables() =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkListRefundables(that: this);

  Future<LnUrlCallbackStatus> lnurlAuth({required LnUrlAuthRequestData reqData}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkLnurlAuth(that: this, reqData: reqData);

  Future<LnUrlPayResult> lnurlPay({required LnUrlPayRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkLnurlPay(that: this, req: req);

  Future<LnUrlWithdrawResult> lnurlWithdraw({required LnUrlWithdrawRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkLnurlWithdraw(that: this, req: req);

  Future<InputType> parse({required String input}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkParse(that: this, input: input);

  Future<SendPaymentResponse> payOnchain({required PayOnchainRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkPayOnchain(that: this, req: req);

  Future<PrepareBuyBitcoinResponse> prepareBuyBitcoin({required PrepareBuyBitcoinRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkPrepareBuyBitcoin(that: this, req: req);

  Future<PrepareLnUrlPayResponse> prepareLnurlPay({required PrepareLnUrlPayRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkPrepareLnurlPay(that: this, req: req);

  Future<PreparePayOnchainResponse> preparePayOnchain({required PreparePayOnchainRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkPreparePayOnchain(that: this, req: req);

  Future<PrepareReceiveResponse> prepareReceivePayment({required PrepareReceiveRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkPrepareReceivePayment(that: this, req: req);

  Future<PrepareRefundResponse> prepareRefund({required PrepareRefundRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkPrepareRefund(that: this, req: req);

  Future<PrepareSendResponse> prepareSendPayment({required PrepareSendRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkPrepareSendPayment(that: this, req: req);

  Future<ReceivePaymentResponse> receivePayment({required ReceivePaymentRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkReceivePayment(that: this, req: req);

  Future<RecommendedFees> recommendedFees() =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkRecommendedFees(that: this);

  Future<RefundResponse> refund({required RefundRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkRefund(that: this, req: req);

  Future<void> registerWebhook({required String webhookUrl}) => BreezLiquid.instance.api
      .crateBindingsBindingLiquidSdkRegisterWebhook(that: this, webhookUrl: webhookUrl);

  Future<void> rescanOnchainSwaps() =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkRescanOnchainSwaps(that: this);

  void restore({required RestoreRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkRestore(that: this, req: req);

  Future<SendPaymentResponse> sendPayment({required SendPaymentRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkSendPayment(that: this, req: req);

  SignMessageResponse signMessage({required SignMessageRequest req}) =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkSignMessage(that: this, req: req);

  Future<void> sync() => BreezLiquid.instance.api.crateBindingsBindingLiquidSdkSync(that: this);

  Future<void> unregisterWebhook() =>
      BreezLiquid.instance.api.crateBindingsBindingLiquidSdkUnregisterWebhook(that: this);
}
